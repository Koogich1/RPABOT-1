...
const workbook = XLSX.readFile('./excelTAB/бЮРо23.xlsx');
...
const pairValueB = pairValue;
const pairValueTB = pairValueT;
const pairValue2B = pairValue2;
const pairValue2TB = pairValue2T;
const pairValue3B = pairValue3;
const pairValue3BT = pairValue3T;

module.exports = { pairValueB, pairValueTB, pairValue2B, pairValue2TB, pairValue3B, pairValue3BT};